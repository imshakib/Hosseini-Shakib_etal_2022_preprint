haz_risk_run<-function(i){
  ...
  writeRaster(
    model_hazard,
    paste0("./Outputs/OAT/Extent/Run_", i, ".asc"),
    format = "ascii",
    overwrite = T
  )
  writeRaster(
    houses_model_hazard,
    paste0("./Outputs/OAT/Hazard/Run_", i, ".asc"),
    format = "ascii",
    overwrite = T
  )
  writeRaster(
    houses_model_risk,
    paste0("./Outputs/OAT/Risk/Run_", i, ".asc"),
    format = "ascii",
    overwrite = T
  )
  ...
  write.csv(outputs, paste0("./Outputs/OAT/Summary/Run_", i, ".csv"))
}
